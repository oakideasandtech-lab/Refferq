...
import { COMPANY_NAME, getAppUrl } from './company';
  ...
  private generateReferralNotificationHTML(data: ReferralNotificationData, _symbol?: string): string {
    ...
    <body>
      ...
      <div class="content">
        ...
        <div style="text-align: center;">
          <a href="${getAppUrl()}/admin" class="button">Review Referral</a>
        </div>
  ...
  private generateApprovalEmailHTML(data: ApprovalEmailData, _symbol?: string): string {
    ...
    <body>
      ...
      <div class="content">
        ...
        <div style="text-align: center;">
          <a href="${getAppUrl()}/affiliate" class="button">View Dashboard</a>
        </div>
  ...
  private generateConversionNotificationHTML(data: ConversionNotificationData, symbol: string): string {
    ...
    <body>
      ...
      <div class="content">
        ...
        <div style="text-align: center;">
          <a href="${getAppUrl()}/affiliate" class="button">View Your Dashboard</a>
        </div>
    ...
    return this.sendTemplatedEmail({
      ...
      <body>
        ...
        <div class="content">
          ...
          <div style="text-align: center;">
            <a href="${getAppUrl()}/affiliate" class="button">View Payout Status</a>
          </div>
